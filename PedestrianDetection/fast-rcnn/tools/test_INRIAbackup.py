...
def runTest(net, folder, classes):
    IoUThresh = 0.7
...
#    split_line = annotationfile.readline().strip().split()
	...
	for i in range(inds.size):
	    ...
	    for j in range(gt_num):
		Overlap = 0
	        if ComputeIoU(dets[inds[i], :4], gt_boxes[j, :]) >= IoUThresh:
		    count += 1
		    Overlap = 1
		    break
	    if Overlap:
    ...
    print 'Average Precision is', float(count*1.0/ind_sum)
    print 'Average Recall is', float(count*1.0/gt_sum)
...
if __name__ == '__main__':
    ...
    caffemodel = '/home/zywang/fast-rcnn/output/default/INRIATrain/caffenet_fast_rcnn_INRIA_iter_10000.caffemodel'
    ...
    #caffemodel = '/home/zywang/fast-rcnn/output/default/INRIATrain/vgg_cnn_m_1024_fast_rcnn_iter_10000.caffemodel'
    ...
    runTest(net, '/home/zywang/INRIATest/DataSet/', ('person',))
    print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
